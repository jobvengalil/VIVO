...
st.set_page_config(page_title="ViVO", layout="wide")      # ✅ Streamlit configuration
...
with st.sidebar:                                                                        # 📁 Sidebar
    ...
    st.sidebar.markdown("""
        <div style="position: absolute; top: 20px; right: 10px; font-size: 12px; color: gray;">
            <b>Developed by:</b> Job Vengalil &copy;
        </div>
    """, unsafe_allow_html=True)

# 💬 Chat Interface
st.title("🤖 Virtual Intelligence @ Vineyard Offshore")
